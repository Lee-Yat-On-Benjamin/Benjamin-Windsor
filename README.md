...
该文章从微信群内转账可能暴露用户汉字全名，有泄露隐私风险的现状出发，介绍如何在合规的前提下，使用内地银行发行的信用卡来完成实名认证，从而只暴露英文名的最后一个字的方法。

![](./assets/0014.png)

中国内地银行发行的银联信用卡，都会按照美国的合规要求，给持卡人注入英文姓名。而内地的所有软体，实质上是透过银联提供的 API 来实现实名认证。

在 2021 年，微信是可以透过绑定信用卡来将汉字实名更换为英文名。但表哥也在文章内义务告知风险，如 500 元转账限额，谨慎考虑后再食用。

这篇文章本来就不是写给李睿恒这种没有信用卡的人看的。互联网当然是很多人的娱乐方式，用小号来吹水、打拳或钓鱼，其实都是不足挂齿的事。
